#ifndef EICZDCBASE_RAWTOWERZDC_H
#define EICZDCBASE_RAWTOWERZDC_H
...
class RawTowerZDC : public PHObject
{
 public:
  ...
  virtual void set_id(RawTowerZDCDefs::keytype) { PHOOL_VIRTUAL_WARN("set_id()"); }
  ...
  virtual void set_key(RawTowerZDCDefs::keytype id) { set_id(id); }
  virtual RawTowerZDCDefs::keytype get_key() const { return get_id(); }
  ...
  //! 2.add a short name to RawTowerZDC::get_property_info
  enum PROPERTY
  {  //
 ...
 protected:
  ...
  ClassDefOverride(RawTowerZDC, 1)
};
