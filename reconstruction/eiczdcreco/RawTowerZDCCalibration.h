#ifndef EICZDCRECO_RAWTOWERZDCCALIBRATION_H
#define EICZDCRECO_RAWTOWERZDCCALIBRATION_H
...
class RawTowerZDCCalibration : public SubsysReco
{
 public:
  ...
  {
    std::cout << "RawTowerZDCCalibration::set_zero_suppression_GeV is deprecated!" << std::endl
 ...
 protected:
  ...
  RawTowerZDCContainer *_calib_towers;
  RawTowerZDCContainer *_raw_towers;
  RawTowerZDCGeomContainer *rawtowergeom;
