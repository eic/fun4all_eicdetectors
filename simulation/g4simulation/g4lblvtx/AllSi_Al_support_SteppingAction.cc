...
#include "AllSi_Al_support_SteppingAction.h"
...
//____________________________________________________________________________..
AllSi_Al_support_SteppingAction::AllSi_Al_support_SteppingAction(AllSi_Al_support_Detector *detector, const PHParameters *parameters)
...
bool AllSi_Al_support_SteppingAction::UserSteppingAction(const G4Step *aStep,bool was_used)
{
...
void AllSi_Al_support_SteppingAction::SetInterfacePointers(PHCompositeNode *topNode)
{
  ...
  if (!m_HitContainer)
  {
    std::cout << "AllSi_Al_support_SteppingAction::SetTopNode - unable to find "
