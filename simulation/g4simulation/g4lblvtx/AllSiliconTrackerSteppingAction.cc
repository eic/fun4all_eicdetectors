...
AllSiliconTrackerSteppingAction::AllSiliconTrackerSteppingAction(AllSiliconTrackerDetector *detector, const PHParameters *parameters)
...
//____________________________________________________________________________..
AllSiliconTrackerSteppingAction::~AllSiliconTrackerSteppingAction()
{
...
bool AllSiliconTrackerSteppingAction::UserSteppingAction(const G4Step *aStep, bool was_used)
{
