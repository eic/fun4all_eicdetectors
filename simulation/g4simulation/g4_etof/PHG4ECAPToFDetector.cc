...
void PHG4ECAPToFDetector::ConstructMe(G4LogicalVolume *logicWorld)
{
  ...
  cout << " passed on parameters from macros :: " << endl;
  cout << "n_fgas_layer :"  << n_fgas_layer << endl;
  cout << "n_bgas_layer : " << n_bgas_layer << endl;
  cout << "gas_gap : " <<gas_gap<< endl;
  cout << "glass_thick : " << glass_thick<< endl;
  cout << "carbon_thick : " <<carbon_thick<< endl;
  cout << "pcb_thick : " <<pcb_thick<< endl;
  cout << "cu_thick : " <<cu_thick<< endl;
  cout << "honeycomb_thick : " <<honeycomb_thick<< endl;
  cout << "mylar_thick : " <<mylar_thick<< endl;
  cout << "Rin : " <<Rin<< endl;
  cout << "Rout : " << Rout<< endl;
  cout << "z_begin : " <<z_begin<< endl;
  ...
  cout << "Mother vol dimensions : " <<  endl;
  cout << " z begin :" << z_begin << endl;
  cout << " tot_thick :" << tot_thick << endl;
  cout << " mid pos :" << posz << endl;
  ...
  cout <<" Front HC mid pos :" << fhc_pos << endl;
  //Front PCB
  ...
  cout  << " Front PCB mid pos : " << fpcb_pos << endl;
  ...
  cout << " Front PCB Cu pos : " << fpcbcu_pos << endl;
  ...
  cout << " Front mylar pos :"  << fmylar_pos << endl; 
  //Carbon layer
  ...
  cout << " front Carbon pos :" << fcarbon_pos << endl ;
  //mrpc and gas layers
  ...
  char gl_solid_name[1000];
  char gl_logic_name[1000];
  char gl_phys_name[1000];
  
  char gas_solid_name[1000];
  char gas_logic_name[1000];
  char gas_phys_name[1000];
  ...
  for(int l = 0 ;  l < n_fgas_layer+1; l++){
    ...
    */
    ...
    sprintf(gl_solid_name, "fglass_solid_%d", l);
    sprintf(gl_logic_name, "fglass_logic_%d", l);
    sprintf(gl_phys_name, "fglass_phys_%d", l);
	...
	fgas_logic[l] = new G4LogicalVolume(fgas_solid[l], G4_gas,"front_gas_Logic_%d",0 , 0,0);
      */
      ...
      sprintf(gas_solid_name, "fgas_solid_%d", l);
      sprintf(gas_logic_name, "fgas_logic_%d", l);
      sprintf(gas_phys_name, "fgas_phys_%d", l);
    ...
    cout << " Front glass layer : " << l << " glass mid : " << glass_mid_pos << endl;
    cout << "Front gas layer : " << l << " gas mid : " << gas_mid_pos << endl;
  ...
  cout << " Middle Carbon pos :" << mcarbon_pos << endl;
  ...
  cout << " Middle mylar pos :" << mmylar_pos << endl;
  ...
  cout << " Middle PCB Cu pos :" << mpcbcu_pos << endl;
  ...
  cout << " Middle PCB pos :" << mpcb_pos << endl;
  ...
  cout << " Middle PCB Cu pos :" << mpcbcu2_pos << endl;
  ...
  cout << " Middle mylar pos :" << mmylar2_pos << endl;
  ...
  cout << " Middle PCB back Carbon pos :" << mcarbon2_pos <<  endl;
  ...
  cout << " Back glass begin pos : " << bglass_begin_pos << endl;
  cout << " Back gas begin pos : "  << bgas_begin_pos << endl;
  ...
  char bgl_solid_name[1000];
  char bgl_logic_name[1000];
  char bgl_phys_name[1000];
  
  char bgas_solid_name[1000];
  char bgas_logic_name[1000];
  char bgas_phys_name[1000];
  ...
  for(int l = 0 ;  l < n_bgas_layer+1; l++){
    ...
    */
    sprintf(bgl_solid_name, "bglass_solid_%d", l);
    sprintf(bgl_logic_name, "bglass_logic_%d", l);
    sprintf(bgl_phys_name, "bglass_phys_%d", l);
    ...
    //bglass_phys[l] =  new G4PVPlacement(0, G4ThreeVector(0, 0, bglass_mid_pos), bglass_logic[l], sprintf("MRPCback_layer_phys_%d",l), Logic, 0, false, OverlapCheck());
	...
	bgas_logic[l] = new G4LogicalVolume(bgas_solid[l], G4_gas, "back_gas_Logic",0 , 0,0);
      */
      sprintf(bgas_solid_name, "bgas_solid_%d", l);
      sprintf(bgas_logic_name, "bgas_logic_%d", l);
      sprintf(bgas_phys_name, "bgas_phys_%d", l);
    ...
    cout << " Back glass layer : " << l << " glass mid : " << bglass_mid_pos << endl;
    cout << "Back gas layer : " << l << " gas mid : " << bgas_mid_pos << endl;
  }
  ...
  cout << " back carbon mid :" << bcarbon_pos << endl;
  ...
  cout << " Back mylar pos :" << bmylar_pos << endl;
  ...
  cout << " Middle PCB back Cu pos :" << bpcbcu_pos << endl;
  ...
  cout << " Back PCB pos :" << bpcb_pos << endl;
  ...
  cout <<" Front HC mid pos :" << bhc_pos << endl;
