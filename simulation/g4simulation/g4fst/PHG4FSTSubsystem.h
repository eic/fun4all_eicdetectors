...
//  -*- C++ -*-.
#ifndef G4DETECTORS_PHG4FSTSUBSYSTEM_H
#define G4DETECTORS_PHG4FSTSUBSYSTEM_H
...
class PHG4FSTSubsystem : public PHG4DetectorSubsystem
{
 public:
  /** Constructor
   */
  PHG4FSTSubsystem(const std::string &name = "FORWARD_HCAL_DEFAULT", const int layer = 0);

  /** Destructor
   */
  virtual ~PHG4FSTSubsystem();
