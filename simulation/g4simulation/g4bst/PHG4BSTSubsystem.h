...
//  -*- C++ -*-.
#ifndef G4DETECTORS_PHG4BSTSUBSYSTEM_H
#define G4DETECTORS_PHG4BSTSUBSYSTEM_H
...
class PHG4BSTSubsystem : public PHG4DetectorSubsystem
{
 public:
  /** Constructor
   */
  PHG4BSTSubsystem(const std::string &name = "FORWARD_HCAL_DEFAULT", const int layer = 0);

  /** Destructor
   */
  virtual ~PHG4BSTSubsystem();
