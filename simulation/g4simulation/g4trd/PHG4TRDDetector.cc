...
void PHG4TRDDetector::ConstructMe(G4LogicalVolume *logicWorld)
{
  ...
  if (Verbosity() > 0) 
  {
    std::cout << "Mother CENTER Pos  ( z ) :"
              << " " << PosZ << " Mother length " << ThicknessZ << std::endl;
  }
  ...
  */
  ...
  if (Verbosity() > 0) 
  {
    std::cout << " Rad CENTER  pos z :"
              << " " << fRadZ << " "
              << " Radiator thick :" << fRadThick << " Rad z near absorber : " << std::endl;
  }
  ...
  if (Verbosity() > 0) 
  {
    std::cout << " pos z of absorber :"
              << " " << det_Pos_Z << " "
              << " Absorber thickness :"
              << " " << det_ThicknessZ << std::endl;
  }
  ...
  if (Verbosity() > 0) std::cout << " det RIN :" << det_RIn << " det ROUT :" << det_ROut << std::endl;
  /*
