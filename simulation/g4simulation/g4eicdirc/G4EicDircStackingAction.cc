...
G4EicDircStackingAction::G4EicDircStackingAction(G4EicDircDetector* detector)
  : PHG4StackingAction(detector->GetName())
  , m_Detector(detector)
{
  m_RandomGenerator = gsl_rng_alloc(gsl_rng_mt19937);
  gsl_rng_set(m_RandomGenerator, PHRandomSeed());
