#ifndef G4CALO__BwdRAWTOWERBUILDERBYHITINDEX_H
#define G4CALO__BwdRAWTOWERBUILDERBYHITINDEX_H
 ...
 *
 */
class BwdRawTowerBuilderByHitIndex : public SubsysReco
{
 public:
  BwdRawTowerBuilderByHitIndex(const std::string &name = "BwdRawTowerBuilderByHitIndex");
  ~BwdRawTowerBuilderByHitIndex() override {}
