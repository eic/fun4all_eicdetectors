#ifndef G4CALO__RAWTOWERBUILDERBYHITINDEXLHCAL_H
#define G4CALO__RAWTOWERBUILDERBYHITINDEXLHCAL_H
 ...
 *
 */
class RawTowerBuilderByHitIndexLHCal : public SubsysReco
{
 public:
  RawTowerBuilderByHitIndexLHCal(const std::string &name = "RawTowerBuilderByHitIndexLHCal");
  ~RawTowerBuilderByHitIndexLHCal() override {}
