#ifndef G4CALO__B0RAWTOWERBUILDERBYHITINDEX_H
#define G4CALO__B0RAWTOWERBUILDERBYHITINDEX_H
 ...
 *
 */
class B0RawTowerBuilderByHitIndex : public SubsysReco
{
 public:
  B0RawTowerBuilderByHitIndex(const std::string &name = "B0RawTowerBuilderByHitIndex");
  ~B0RawTowerBuilderByHitIndex() override {}
