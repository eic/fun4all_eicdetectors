...
//  -*- C++ -*-.
#ifndef G4DETECTORS_PHG4FORWARDDUALREADOUTDETECTOR_H
#define G4DETECTORS_PHG4FORWARDDUALREADOUTDETECTOR_H
...
class PHG4ForwardDualReadoutDetector : public PHG4Detector
{
 public:
  //! constructor
