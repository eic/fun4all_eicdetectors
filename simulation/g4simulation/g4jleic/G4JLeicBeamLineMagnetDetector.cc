...
G4JLeicBeamLineMagnetDetector::G4JLeicBeamLineMagnetDetector(PHG4Subsystem *subsys, PHCompositeNode *Node, PHParameters *parameters, const std::string &dnam, const int lyr)
  : PHG4Detector(subsys, Node, dnam)
  , params(parameters)
  , magnet_physi(nullptr)
  , magnet_iron_physi(nullptr)
  , m_DisplayAction(dynamic_cast<G4JLeicBeamLineMagnetDisplayAction *>(subsys->GetDisplayAction()))
  , layer(lyr)
{
}
