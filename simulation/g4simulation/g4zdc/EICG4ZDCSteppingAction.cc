...
//               Attach Layer and channel ID to G4Hits for TTree/Ntuple production
//  -14/Dec/2021 Second ZDC design. Modifications for digitization.
...
//____________________________________________________________________________..
EICG4ZDCSteppingAction::EICG4ZDCSteppingAction(EICG4ZDCDetector *detector, const PHParameters *parameters)
...
//____________________________________________________________________________..
EICG4ZDCSteppingAction::~EICG4ZDCSteppingAction()
{
...
bool EICG4ZDCSteppingAction::UserSteppingAction(const G4Step *aStep,bool was_used)
{
...
//____________________________________________________________________________..
void EICG4ZDCSteppingAction::SetInterfacePointers(PHCompositeNode *topNode)
{
  ...
  if (!m_HitContainer)
  {
    std::cout << "EICG4ZDCSteppingAction::SetTopNode - unable to find "
