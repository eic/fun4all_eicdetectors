...
//____________________________________________________________________________..
EicFRichSteppingAction::EicFRichSteppingAction(EicFRichDetector *detector, const PHParameters *parameters)
...
//____________________________________________________________________________..
EicFRichSteppingAction::~EicFRichSteppingAction()
{
...
bool EicFRichSteppingAction::UserSteppingAction(const G4Step *aStep,bool was_used)
{
...
//____________________________________________________________________________..
void EicFRichSteppingAction::SetInterfacePointers(PHCompositeNode *topNode)
{
  ...
  if (!m_HitContainer)
  {
    std::cout << "EicFRichSteppingAction::SetTopNode - unable to find "
